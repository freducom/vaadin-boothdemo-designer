package com.vaadin.javaone.client.samples;
...
import com.vaadin.javaone.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.vaadin.javaone.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
